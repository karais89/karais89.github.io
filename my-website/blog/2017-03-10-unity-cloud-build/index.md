...
![Download Sourcetree](./download_sourcetree_0.png)
...
![Create Your Repo](./create_your_repo.png)

### 03. SourceTree를 사용하여 Bitbucket에 저장소를 만듭니다.

SourceTree를 열고 Bitbucket 로그인 사용자 이름과 암호를 입력하라는 메시지가 나타나면 입력하십시오.

![Create a repository on bitbucket](./create_a_repository_on_bitbucket.png)
...
![Skip Setup](./04-skip_setup.png)

"Skip Setup"을 클릭하면 Repository Browser 창이 나타납니다.

![Repository Browser](./05-repository_browser.png)
...
![New Repository Options](./06-new_repository_options.png)

"Create a remote repository" 창이 나타납니다.

![Create A Remote Repository](./07-create_a_remote_repository.png)
...
![Clone A Repository](./09-clone_a_repository.png)
...
![Populate Your Local Repository](./12-populate_your_local_repository.png)

로컬 repo를 채울 때 SourceTree는 자동으로 변경 사항을 감지하고 다음과 같이 업데이트합니다 :

![First Repsoitory](./13-first_repsoitory.png)
...
![First Commit](./14-first_commit.png)

Comment를 입력하고 "Commit"을 클릭하십시오.

![First Commit 2](./15-first_commit_2.png)

다음 메시지가 나타납니다. "There is nothing left to commit"

![Nothing to commit](./16-nothing_to_commit_0.png)
...
![Repote Repository](./18-repote_repository.png)
...
![Cloud Build Home Page](./3.01-cloud_build_home_page_0.png)

Cloud Build 홈 페이지에서 "Add New"를 클릭하십시오. Cloud Build는 프로젝트의 이름과 프로젝트가 속한 조직의 이름을 선택하도록 요청합니다.

![Create New Project](./3.02-create_new_project.png)
...
![Connect To Repository](./3.03-connect_to_repository.png)
...
![Select Build Targetb Update](./3.06-select_build_targetb_update_0.png)

자세한 구성 정보를 제공하라는 메시지가 나타납니다. 빌드 할 Repo에서 지점을 선택해야합니다. 레슨 2의 Bitbucket 레포를 사용하는 경우 "마스터"를 선택하십시오.

![Select Build Branch](./3.07-select_build_branch.png)

### 05. 빌드!

"Next"를 클릭하면 Unity Cloud Build가 자동으로 컴파일을 시작합니다.

![Select Build Branch](./3.08-buildb.png)
...
![Build Pipeline](./4.01-build_pipeline.png)
